...
Each solution has a refernce number assigned based on a suffix and a count
...
column_headers=([['Sol_Ref', r'$f_{heat} $',r'$f_{flood} $',r'$f_{brownfield} $',
                  r'$f_{density} $', r'$f_{regeneration} $',r'$f_{sprawl} $',
                    'development plan']])        
...
def SavetoCsv(name, array, Results_folder, suffix):
    ...
    with open(Results_folder+name+".csv", "wb") as f:
        ...
        # defined at the top of the module for ease
