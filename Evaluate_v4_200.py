...
Changes:
    ...
    + Working at 200m spatial resolution
...
def Plan(Development_Plan):
    ...
    import Undev_brwnfld_Inten_Lookup_200 as Lookup
...
def Calc_fmixedlanduse(Development_Plan):
    ...
    Landuse     =  rasterIO.readrasterband(rasterIO.opengdalraster(data_folder+'Landuse.tif'),1)
