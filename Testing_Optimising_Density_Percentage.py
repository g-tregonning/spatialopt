...
Site_Min, Site_Max = 0, 100
Prop_Min, Prop_Max = 0, 10
No_Sites = 20

toolbox = base.Toolbox()
toolbox.register("attr_site", rndm.randint, Site_Min, Site_Max)
toolbox.register("attr_prop", rndm.randint, Prop_Min, Prop_Max)
toolbox.register("individual", tools.initCycle, creator.Individual,
                 (toolbox.attr_site, toolbox.attr_prop), n=No_Sites)
